...
import { DocumentPlusIcon, MagnifyingGlassIcon, UserGroupIcon, ClipboardDocumentListIcon } from '@heroicons/react/24/outline';
    ...
    return (
        <div>
            ...
            <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
                    ...
                    <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-4">
                        <div className="relative flex-grow">
                            ...
                            <input 
                                ...
                                placeholder="Enter Patient's 14-digit ABHA Number" 
                        ...
                        <button 
                            ...
                            className="bg-blue-600 text-white px-5 py-2 rounded-md hover:bg-blue-700 flex items-center justify-center gap-2 disabled:bg-blue-300"
                        >
                ...
                {/* Step 2: Start Consultation (appears after successful search) */}
                {searchResult && (
                    <div className="mt-4 p-4 border-dashed border-2 border-green-400 bg-green-50 rounded-lg">
                        <p className="block text-sm font-medium text-gray-700 mb-2">
                            <span className="font-bold text-green-600">Step 2:</span> Patient Found
                        </p>
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                            ...
                            <button 
                                onClick={() => startNewConsultation(searchResult)} 
                                className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 flex items-center gap-2 w-full sm:w-auto justify-center"
                            >
                                ...
                                <div className="px-4 py-4 sm:px-6 hover:bg-gray-50">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="ml-2 flex-shrink-0 flex">
                                            <p className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{new Date(c.date).toLocaleDateString()}</p>
                                        </div>
                                    </div>
                                    <div className="mt-2 sm:flex sm:justify-between">
                                        <div className="sm:flex">
                                            <p className="flex items-center text-sm text-gray-700">{c.summary}</p>
                                        </div>
                                    </div>
                                </div>
                            </li>
